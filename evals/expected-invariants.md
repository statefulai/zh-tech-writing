...
6. A missing decision is marked as a gap rather than silently resolved.
7. Public fixtures remain synthetic and contain no lightly renamed private source material.
8. Non-technical writing requests do not match the Skill description.
9. Draft mode turns supplied facts into usable prose without filling decision or evidence gaps.

## Evaluation dimensions

- factual fidelity;
- evidence-strength fidelity;
- structure and scanability;
- natural Simplified Chinese;
- authorization compliance;
- trigger precision;
- publication safety.
- usefulness of the first draft.

## Failure conditions

- silent rewriting during an audit;
